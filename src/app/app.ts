...
@Component({
  selector: 'app-root',
  imports: [RouterOutlet, RouterLink, RouterLinkActive, ToastHostComponent, ModalHostComponent],
...
export class App {
  ...
  readonly dark = signal(document.documentElement.getAttribute('data-bs-theme') === 'dark');
