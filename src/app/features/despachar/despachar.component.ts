        ...
        >
          ...
          <div class="grid grid-cols-2 gap-2 border-b border-slate-200 bg-slate-100 px-3 py-2 dark:border-slate-800 dark:bg-slate-800">
            <div>
              ...
              <select id="selChofer" class="select" [value]="chofer()" (change)="chofer.set($any($event.target).value)">
            ...
            <div>
              ...
              <select id="selPlaca" class="select" [value]="placa()" (change)="placa.set($any($event.target).value)">
                <option value="">-- Seleccionar --</option>
